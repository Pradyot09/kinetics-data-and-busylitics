    ...
    <>
      <header className="text-center pt-24">
        ...
        >
          <Image
            alt="edmontonimage2"
            src="/video/Edmontonimage2.webp"
            layout="fill"
            style={{ objectFit: "cover" }}
          />
        </div>
        <div className="text-white py-16 position:fixed">
          <h2 className="text-5xl underline underline-offset-8 ">
            For Business Enquiries{" "}
          </h2>
          <p className="text-6xl  flex justify-center py-3">
            Kinetics Data & Buslytics LLC
          </p>
          ...
          <p className="inline-flex text-3xl px-3 text-white">
            <svg
